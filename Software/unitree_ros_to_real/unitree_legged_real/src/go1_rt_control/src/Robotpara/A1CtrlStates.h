...
public:
    ...
    void reset() {
        ...
        robot_mass = 12.0;
        a1_trunk_inertia << 0.0168352186, 0.0004636141, 0.0002367952,
        ...
        default_foot_pos << 0.206, 0.206, -0.17, -0.17,
                0.16, -0.16, 0.16, -0.16,
                -0.309458, -0.309458, -0.309458, -0.309458;
    ...
    ////////////////////// this function used for Gazebo simulation
    void resetFromROSParam(ros::NodeHandle &_nh) {
        ...
        _nh.param("a1_trunk_inertia_xx", a1_trunk_inertia_xx, 0.0168533);
        _nh.param("a1_trunk_inertia_xy", a1_trunk_inertia_xy, 0.0004636141);
        _nh.param("a1_trunk_inertia_xz", a1_trunk_inertia_xz, 0.0002367952);
        _nh.param("a1_trunk_inertia_yz", a1_trunk_inertia_yz, 3.6671e-05);
        _nh.param("a1_trunk_inertia_yy", a1_trunk_inertia_yy, 0.0656);
        ...
        _nh.param("a1_default_foot_pos_FL_x", a1_default_foot_pos_FL_x, 0.206);
        _nh.param("a1_default_foot_pos_FL_y", a1_default_foot_pos_FL_y, 0.16);
        _nh.param("a1_default_foot_pos_FL_z", a1_default_foot_pos_FL_z, -0.31);

        _nh.param("a1_default_foot_pos_FR_x", a1_default_foot_pos_FR_x, 0.206);
        _nh.param("a1_default_foot_pos_FR_y", a1_default_foot_pos_FR_y, -0.16);
        _nh.param("a1_default_foot_pos_FR_z", a1_default_foot_pos_FR_z, -0.31);

        _nh.param("a1_default_foot_pos_RL_x", a1_default_foot_pos_RL_x, -0.17);
        _nh.param("a1_default_foot_pos_RL_y", a1_default_foot_pos_RL_y, 0.16);
        _nh.param("a1_default_foot_pos_RL_z", a1_default_foot_pos_RL_z, -0.31);
        ...
        _nh.param("a1_default_foot_pos_RR_z", a1_default_foot_pos_RR_z, -0.31);
        ...
        _nh.param("a1_kd_foot_x", a1_kd_foot_x, 8.0);
        _nh.param("a1_kd_foot_y", a1_kd_foot_y, 8.0);
        _nh.param("a1_kd_foot_z", a1_kd_foot_z, 8.0);
    ...
    Eigen::Matrix<double, NUM_DOF_PER_LEG, 1> km_foot;   ////// for swing leg impedance control 
