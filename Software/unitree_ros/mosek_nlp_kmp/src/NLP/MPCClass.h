...
public:
	...
	Eigen::Matrix<double, 38, 1> step_timing_opti_loop(int i,Eigen::Matrix<double,18,1> estimated_state, 
...
// private:    
	...
	Eigen::Matrix<double,1,_nsum> _zmpx_real, _zmpy_real, _dcmx_real,_dcmy_real;
